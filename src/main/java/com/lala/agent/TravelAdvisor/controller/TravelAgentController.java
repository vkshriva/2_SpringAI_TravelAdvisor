...
public class TravelAgentController {
    ...
    @PostMapping("/recommend-using-ollama")
    public ResponseEntity<?> recommendTravelPlanUsingOllama(@RequestParam("city") String city, @RequestParam("days") int days) {
      try{
          ...
          TravelResponse response = ollamachatClient.prompt()
